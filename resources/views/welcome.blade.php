            ...
            <div class="col-lg-6">
                <div class="hero-image text-center">
                    <div class="placeholder-hero">
                        <img src="{{ asset('images/banner.jpg') }}" alt="Banner da Cervejaria" style="max-width: 100%; height: auto; border-radius: 20px;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="event-content">
                    ...
                    <div class="event-meta">
                        <small class="text-muted">
                            <i class="bi bi-calendar3"></i> {{ \Carbon\Carbon::parse($event->date)->format('d/m/Y') }}
                        </small>
                        <small class="text-muted">
